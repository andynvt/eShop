                    ...
                    child: Stack(
                      children: [
                        ClipRRect(
                            ...
                            child: Stack(children: [
                              FadeInImage(
                                image: NetworkImage(saveLaterList[index].productList![0].type ==
                                    "variable_product" &&
                                    saveLaterList[index]
                                        .productList![0]
                                        .prVarientList![selectedPos]
...
print("cartslist len***${cartList.length}");
    if(cartList.isNotEmpty) {
      ...
      SectionModel? tempId
      = cartList.firstWhereOrNull((cp) =>
      cp.id == saveLaterList[index].productList![0].id && cp.varientId ==
          saveLaterList[index].productList![0].prVarientList![selectedPos].id!) ;
      print("tempId****$tempId");
      if (tempId != null) {
        context.read<CartProvider>().updateCartItem(
            saveLaterList[index].productList![0].id,
            (int.parse(tempId.qty!) + int.parse(
                saveLaterList[index]
                    .productList![0]
                    .qtyStepSize!)).toString(),
            selectedPos,
            saveLaterList[index].productList![0].prVarientList![selectedPos]
                .id!);
        saveLaterList.removeAt(index);
      } else {
                                        ...
                                        Padding(
                                          ...
                                          child: SimBtn(
                                              ...
                                              onBtnSelected: /*_placeOrder
                                                  ...
                                                  () {
                                                print(
                                                    "is local pickup****$IS_LOCAL_PICKUP****$isStorePickUp");
                                                checkoutState!(() {
                                                  _placeOrder = false;
                                                });
