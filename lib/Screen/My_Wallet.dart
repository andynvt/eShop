...
class StateWallet extends State<MyWallet> with TickerProviderStateMixin {
  ...
  withDrawDailog() {
    return dialogAnimate(
        ...
        AlertDialog(
          ...
          title: Text(getTranslated(context, 'SEND_WITHD_REQ_LBL')!, textAlign: TextAlign.center),
  ...
  stripePayment(int price) async {
    ...
    print("price****$price****$stripeCurCode***");
