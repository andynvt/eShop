...
class _GettingStartedScreenState extends State<IntroSlider> with TickerProviderStateMixin {
  int _currentPage = 0;
                ...
                return SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        padding: const EdgeInsetsDirectional.only(top: 30.0, start: 15.0, end: 15.0),
  ...
  _btn() {
    return Column(
      children: [
        Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, children: getList()),
        Center(
            child: Padding(
