                  ...
                  children: <Widget>[
                    Row(
                      ...
                      children: <Widget>[
                        Expanded(
                          child: Text(
                            "${getTranslated(context, 'AMOUNT')!} : ${getPriceFormat(context,
                                    double.parse(tranList[index].amt!))!}",
                            style: TextStyle(
                    ...
                    tranList[index].type != null &&
                        ...
                        ? Text("${getTranslated(context, 'PAYMENT_METHOD_LBL')!} : ${tranList[index].type!}")
                        : Container(),
                    Padding(
                      padding: const EdgeInsets.symmetric(vertical: 4.0),
                      child: tranList[index].msg != null &&
                              tranList[index].msg!.isNotEmpty
                          ? Text("${getTranslated(context, 'MSG')!} : ${tranList[index].msg!}")
                          : Container(),
                    ),
                    tranList[index].txnID != null &&
                            tranList[index].txnID!.isNotEmpty
                        ? Text("${getTranslated(context, 'Txn_id')!} : ${tranList[index].txnID!}")
                        : Container(),
                  ]))),
    );
  }
